...
export default function AdminDesk({ 
  clients = [], notes = [], businessExpenses = [], currentUser, onAddNote, onUpdateNote, onRemoveNote, 
  ...
  const [noteFilterMonth, setNoteFilterMonth] = useState(''); 
    ...
    <div className="bg-slate-100 p-6 rounded-2xl border border-slate-300 shadow-inner min-h-[900px] flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="bg-blue-50 rounded-xl shadow-sm border border-blue-200 overflow-hidden flex flex-col flex-1 max-h-[350px]">
            ...
            <div className="p-4 flex-1 overflow-y-auto space-y-3 max-h-[350px]">
          ...
          {/* --- HR & COMPLIANCE SCANNER --- */}
          {isMasterAdmin && (
            <div className="bg-red-50 rounded-xl shadow-sm border border-red-200 overflow-hidden flex flex-col flex-1 max-h-[350px]">
              ...
              <div className="p-4 flex-1 overflow-y-auto space-y-2 max-h-[350px]">
                {complianceAlerts.length === 0 ? (
        ...
        <div className="bg-yellow-50 rounded-xl shadow-sm border border-yellow-200 overflow-hidden flex flex-col h-[750px] lg:h-auto lg:max-h-[750px]">
          ...
          <div className="p-4 flex-1 overflow-y-auto space-y-3 max-h-[650px]">
      ...
      <div className="mt-8 border-t-4 border-slate-800 pt-8 flex-1 flex flex-col">
        <AdminFilingCabinet 
          ...
          needsPayrollAlert={needsPayrollAlert}
          paydayStr={paydayStr}
          startStr={startStr}
        />
      </div>
